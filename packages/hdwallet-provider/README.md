...
***This is the same as the @truffle/hdwallet-provider but adjusted so that the engine does not send `skipCache: true` flag which parity treats as an error. Also this supports `signTypedMessage`***
